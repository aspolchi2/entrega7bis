...
export default class ProductsInventory {
  ...
  async agregarProducto(producto) {
    ...
    if (
      ...
      return {
        error:
          "titulo, precio e imagen no pueden estar vacias y precio debe ser un numero",
      };
    }
  }
    ...
    if (pos != -1) {
      if (
        ...
        let newproduct = new Producto(
          producto.nombre ?? oldprod.nombre,
          producto.precio ?? oldprod.precio,
          producto.foto ?? oldprod.foto,
          producto.descripcion ?? oldprod.descripcion,
          producto.codigo ?? oldprod.codigo,
          producto.stock ?? oldprod.stock
        );
